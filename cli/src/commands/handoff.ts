...
import { createHandoffOpenApprovalCommand } from './handoff/open-approval.js';
...
import { createHandoffTransitionCommand } from './handoff/transition.js';
...
export function createHandoffCommand(): Command {
  ...
  command.addCommand(createHandoffTransitionCommand());
  command.addCommand(createHandoffOpenApprovalCommand());
