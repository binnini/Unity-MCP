...
describe('isValidUnityVersion', () => {
  it('accepts standard version formats', () => {
    ...
    expect(isValidUnityVersion('6000.3.6f1')).toBe(true);
  ...
  it('rejects invalid formats', () => {
    ...
    expect(isValidUnityVersion('6000.3.6f1; rm -rf /')).toBe(false);
    expect(isValidUnityVersion('6000.3.6f1\n')).toBe(false);
  });
});
